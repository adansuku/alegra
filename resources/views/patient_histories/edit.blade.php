...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            {!! Form::model($patientHistory, ['route' => ['patientHistories.update', $patientHistory->id], 'method' =>
            'patch', 'enctype' => 'multipart/form-data']) !!} {{-- @php dd($patientHistory) @endphp --}}
            ...
            <div class="row m-0 p-3">
                ...
                <div class="form-group col-sm-6">
                    {!! Form::label('acc_fecha_realiz', 'Fecha de la acción:') !!} {!! Form::date('acc_fecha_realiz',
                    $patientHistory->acc_fecha_realiz, ['class' => 'form-control','id'=>'rea_accion', 'required' =>
                    'required']) !!}
                </div>
                ...
                <div class="form-group col-sm-12 subtipo_acc" id="solic_demandas" style="display: none">
                    ...
                    {!! Form::select('acc_subtipo_accion', [ null => 'Selecciona una opcion', 'Alta' =>
                    'Alta', 'Cambio' =>
                    'Cambio', 'Suspensión' => 'Suspensión', 'Baja' => 'Baja', 'Apoyo Emocional' => 'Apoyo
                    Emocional', 'Intervención Familiar' => 'Intervención Familiar', 'Asesoramiento fisico' =>
                    'Asesoramiento Físico', 'Asesoramiento social' => 'Asesoramiento Social', 'Asesoramiento funcional'
                    => 'Asesoramiento Funcional', 'Asesoramiento
                    cognitivo' => 'Asesoramiento Cognitivo', 'Formación individual' => 'Formación individual',
                    'Intervención familiar' => 'Intervención familiar', 'Otras' => 'Otras (especificar)'], null,
                    ['class' => 'form-control acc_subtipo_accion' ,
                ...
                <div class="form-group col-sm-12 " id="interv_centro" style="display: none">
                    {!! Form::label('acc_subtipo_accion', 'Subtipo Acción/Tarea:') !!}
                    {!! Form::select('acc_subtipo_accion', [ null =>
                    'Selecciona una
                    opcion', 'Valoración Trab.Social' => 'Valoración Trab.Social', 'Visita Centro' => 'Visita Centro',
                    'Acogida 1er Día' => 'Acogida 1er Día', 'Entrega PIA' =>
                    'Entrega PIA', 'Apoyo Emocional' => 'Apoyo Emocional', 'Asesoramiento Individual' => 'Asesoramiento
                    Individual', 'Asesoramiento Físico' => 'Aseoramiento Físico', 'Asesoramiento Social' =>
                    'Asesoramiento Social', 'Asesoramiento Funcional'
                    => 'Asesoramiento Funcional', 'Asesoramiento Cognitivo' => 'Asesoramiento Cognitivo', 'Formación
                    Individual' => 'Formación Individual', 'Intervención Familiar' => 'Intervención Familiar',
                    'Intervención Física Individual' => 'Intervención
                    Física Individual', 'Intervención Funcional Individual' => 'Intervención Funcional Individual',
                ...
                <div class="form-group col-sm-12 " id="interv_domic" style="display: none">
                    ...
                    {!! Form::select('acc_subtipo_accion', [ null => 'Selecciona una
                    opcion', 'Valoración Trab.Social' => 'Valoración Trab.Social', 'Valoración Acogida Inicial Equipo'
                    => 'Valoración Acogida Inicial Equipo', 'Entrega PIA' =>
                    'Entrega PIA', 'Intervención/Mediación Familiar' => 'Intervención/Mediación Familiar',
                    'Asesoramiento Individual' => 'Asesoramiento Individual', 'Apoyo Emocional' => 'Apoyo Emocional',
                    'Formación Individual' => 'Formación Individual',
                    'Fisioterapia a cuidador/a' => 'Fisioterapia a cuidador/a', 'Seguimiento Psicológico Mensual' =>
                    'Seguimiento Psicológico Mensual', 'Asesoramiento Físico' => 'Asesoramiento Físico', 'Asesoramiento
                    Social' => 'Asesoramiento Social',
                    'Asesoramiento Funcional' => 'Asesoramiento Funcional', 'Asesoramiento cognitivo' => 'Asesoramiento
                    cognitivo', 'Otras' => 'Otras (especificar)'], null, ['class' => 'form-control acc_subtipo_accion',
                    'id' => 'interv_domic_opt']) !!}
                </div>
                ...
                <div class="form-group col-sm-12 " id="seg_salud" style="display: none">
                    ...
                    {!! Form::select('acc_subtipo_accion', [ null =>
                    'Selecciona una
                    opcion', 'Cambio valoración de Indicador salud' => 'Cambio valoración de Indicador salud',
                    'Seguimiento Socio Familiar' => 'Seguimiento Socio Familiar', 'Seguimiento
                    Cognitivo' => 'Seguimiento Cognitivo', 'Seguimiento Físico' => 'Seguimiento Físico', 'Seguimiento
                    Emocional' => 'Seguimiento Emocional', 'Seguimiento Funcional' => 'Seguimiento Funcional', 'Nuevo
                    diagnóstico principal' => 'Nuevo diagnóstico
                    principal', 'Cambio importante salud' => 'Cambio importante salud', 'Ficha de seguimiento de
                    intervención' => 'Ficha de seguimiento de intervención', 'Otras' => 'Otras (especificar)'], null,
                    ['class' => 'form-control acc_subtipo_accion',
                    'id' => 'seg_salud_opt']) !!}
                </div>
                ...
                <div class="form-group col-sm-12 " id="docu_cont" style="display: none">
                    ...
                    {!! Form::select('acc_subtipo_accion', [ null =>
                    'Selecciona una
                    opcion', 'Solicitud documento a Acufade' => 'Solicitud documento a Acufade', 'Entrega documento
                    Acufade (a familia)' => 'Entrega documento Acufade (a familia)',
                    'Solicitud documento salud (a familia)' => 'Solicitud documento salud (a familia)', 'Otras' =>
                    'Otras (entregar)'], null, ['class' => 'form-control acc_subtipo_accion', 'id' => 'docu_cont_opt' ])
                    !!}
                </div>
                ...
                <div class="form-group col-sm-12 " id="contab_cont" style="display: none">
                    ...
                    {!! Form::select('acc_subtipo_accion', [ null =>
                    'Selecciona una
                    opcion', 'Comunicación impago a usuario/a' => 'Comunicación impago a usuario/a', 'Comunicación
                    impago a DGDD' => 'Comunicación impago a DGDD', 'Cambio de forma
                    de pago' => 'Cambio de forma de pago', 'Cambio IBAN Bancario' => 'Cambio IBAN Bancario', 'Cambio
                    importe facturación' => 'Cambio importe facturación', 'Cambio cuota socio' => 'Cambio cuota socio',
                    'Situación impago' => 'Situación impago',
                    'Abono de deuda' => 'Abono de deuda', 'Otras' => 'Otras (especificar)'], null, ['class' =>
                    'form-control acc_subtipo_accion', 'id' => 'contab_cont_opt']) !!}
                </div>
                ...
                <div class="form-group col-sm-12 " id="valoracion_ini" style="display: none">
                    ...
                    {!! Form::select('acc_subtipo_accion', [ null =>
                    'Selecciona una
                    opcion', 'Ficha de Acogida' => 'Ficha de Acogida', 'Valoración Adaptación' =>'Valoración Adaptación'
                    , 'Valoración Inicial de Indicador Salud' =>'Valoración
                    Inicial de Indicador Salud' , 'Valoración Inicial Cognitiva' =>'Valoración Inicial Cognitiva' ,
                    'Valoración Inicial Física' =>'Valoración Inicial Física' , 'Valoración Inicial Funcional'
                    =>'Valoración Inicial Funcional' , 'Valoración
                    Inicial Emocional' =>'Valoración Inicial Emocional' , 'Otras' => 'Otras (especificar)'], null,
                    ['class' => 'form-control acc_subtipo_accion', 'id' => 'valoracion_ini_opt']) !!}
                </div>
                ...
                <div class="form-group col-sm-12 p-3 bg-secondary" id="acc_tipo_accion_otro" style="display: none">
                    ...
                    {!! Form::text('acc_tipo_accion_otro', null, ['class' => 'form-control', 'id' =>
                    'acc_tipo_accion_otro_cont_id']) !!}
                </div>


                <!-- Otro subtipo accion-->
                <div class="form-group col-sm-12 p-3 bg-secondary" id="otro_acc_sub_id" style="display: none">
                    {!! Form::label('otro_acc_sub', 'Si no esta en la lista, especifica cual:') !!}
                    {!! Form::text('otro_acc_sub', null, ['class' => 'form-control', 'id' => 'otro_acc_sub_cont_id'])
                    !!}
                </div>
                ...
                <div class="form-group col-sm-12 col-lg-12">
                    {!! Form::label('destinado_a', 'Destinado a:') !!}
                    {!! Form::select('destinado_a[]', [ 'Persona Usuaria' => 'Persona Usuaria', 'Cuidadora Familiar' =>
                    'Cuidadora Familiar', 'Cuidadora Profesional'
                    => 'Cuidadora Profesional', 'Profesional Externa' => 'Profesional
                    Externa', 'Otras' => 'Otras'], null, ['class' => 'select2 form-control','id' =>
                    'destinado_a','multiple' => 'multiple', 'required'=>'required']) !!}
                </div>

                <!-- Observaciones Field -->
                <div class="form-group col-sm-12 col-lg-12">
                    {!! Form::label('acc_descrip', 'Descripción:') !!}
                    {!! Form::textarea('acc_descrip', null, ['class' => 'form-control', 'id' => 'acc_descrip']) !!}
                </div>
                ...
                <!-- Observaciones Field -->
                <div class="form-group col-sm-12 col-lg-12">
                    {!! Form::label('acc_observaciones', 'Observaciones:') !!} {!! Form::text('acc_observaciones', null,
                    ['class' => 'form-control']) !!}
                </div>
