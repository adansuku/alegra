...
<div class="col-lg-6">
    ...
    <div class="card mb-4">
        ...
        <!-- <span id="servId">{!! $patientService->id !!}.</span>--> <strong>Nombre del Servicio: </strong> {!! $patientService->nom_servicio !!}
        </div>
        <div class="card-body">
        <p>
            ...
            <strong>Fecha formalización:</strong> {{ date('d/m/Y', strtotime($patientService->fecha_form_serv )) }}
                ...
                <strong>Observaciones:</strong> {{$item->obs_servicio}}<br><hr>

                <a href="{!! route('patientServicesDates.edit', [$item->id]) !!}" 
        ...
        <div class='btn-group'>
            <!-- <a href="{!! route('patientServices.edit', [$patientService->id]) !!}"
                ...
                data-id="{!! $patientService->id !!}"
                onClick="ShowModal(this)">
                <i class="fas fa-clock"></i>
                    Añadir Horario
                </button>

                <a href="/servicedelete/{{$patientService->id}}"
