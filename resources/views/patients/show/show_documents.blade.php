<table class="table datatables" width="100%" cellspacing="0">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-block btn-secondary btn-xs" href="{{ asset("storage/$item->url") }}" target="_blank"><i class="fas fa-download"></i> Ver / Descargar</a>
                <a href="/deletedocument/{{$item->id}}" data-token="{{csrf_token()}}" class='btn btn-block btn-danger btn-xs'
