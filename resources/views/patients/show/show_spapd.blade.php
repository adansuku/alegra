    ...
    <div class="card">
        <div class="card-header row m-0" id="headingOne">
            ...
            <div class="col-sm-6 p-0 text-right">
                ...
                <a href="/spapddelete/{{$patientSpapd->id}}" data-token="{{csrf_token()}}" class='btn btn-danger btn-xs' onclick="return confirm('¿Estas segura que quieres eliminar el servicio?')">
            ...
            <div class="card-body">
                ...
                <table width="100%"> 
                    ...
                    <tr style="height: 50px; border-bottom: 1px solid lightgrey;">
                        ...
                        <td width="45%">{{ $psd->fecha_inicio }}</th></td>
