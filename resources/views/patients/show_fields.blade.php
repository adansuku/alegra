...
<div class="tab-content">
    ...
    <div class="tab-pane" id="info_sanitaria" role="tabpanel">
        <div class="row py-4">
            ...
            <div class="col-sm-6">
                ...
                <hr> @include('patients.show.show_allergy')
            ...
            <div class="col-sm-6">
                ...
                <hr> @include('patients.show.show_doctor')
        ...
        <div class="row py-4">
            ...
            <div class="col-lg-12">
                ...
                <table class="table datatables" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        @php $fecha_limite = strtotime($patientPia->fecha_limite); $newformat =
                        date('d/m/Y',$fecha_limite); echo '
                        ...
                        <td>
                            @if ($patientPia->fecha_real != null) @if ($patientPia->fecha_limite >
                            $patientPia->fecha_real)
            ...
            <div class="col-sm-12 col-lg-6 pt-3">
                ...
                <hr> @if ($patient->patientHealth->med_centro == "Si")
    ...
    <div class="tab-pane" id="info_social" role="tabpanel">
        ...
        <div class="row py-4">
            ...
            <div class="col-lg-6">
                ...
                <small>Tipo Discapacidad:</small> {!! implode(', ', (array)$patient->patientInfo->tipo_disc) !!} {{--
    ...
    <div class="tab-pane" id="demanda" role="tabpanel">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <p>
                            ...
                            {{--
                                    <strong>Tipo de plaza:</strong> {!! implode(', ', (array)$patientService->tipo_plaza_serv) !!}<br> --}} {{-- <strong>Plaza
        ...
        @php $spapd = 'SPAPD'; $array = array(); @endphp @foreach($patient->patientServices as $patientService) @php
        $array = array($patientService->nom_servicio); @endphp @endforeach @if(in_array($spapd, $array))
            ...
            <div class="col-lg-12">
                <table class="table datatables" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                @if ($patientSpapd->prog_spapd == "Otros") {{$patientSpapd->otros_programa}} @else
                                {{$patientSpapd->prog_spapd}} @endif
                            </td>

                            <td>{!! $patientSpapd->num_sesiones !!}</td>

                            <td>
                                @if ($patientSpapd->dur_spapd == "Otros") {{$patientSpapd->otras_sesiones}} @else
                                {{$patientSpapd->dur_spapd}} @endif

                            </td>

                            <td>
                                @foreach($patientSpapd->dia_spapd as $item)
                                <span class="bg-dark py-1 px-2 text-white">{{$item}}</span> @endforeach
                            </td>
