<div class="row p-3">
    ...
    <div class="form-group col-sm-12">
        {!! Form::label('diagnostico', 'Categoría Diagnóstica:') !!} {!! Form::select('diagnostico', [ 'Envejecimiento
        Activo' => 'Envejecimiento Activo', 'Demencias' => 'Demencias', 'Neurológico' => 'Neurológico', 'Diversidad
        Física' => 'Diversidad Física',
        'Diversidad Intelectual' => 'Diversidad Intelectual', 'Diversidad Psíquico-Afectivo' => 'Diversidad
        Psíquico-Afectivo', 'Cardiopatías' => 'Cardiopatías', 'Prob. Respiratorios' => 'Prob. Respiratorios'], null,
        ['class' => 'form-control', 'onchange'
        => 'diagCon(this.value, this.id);']) !!}
    </div>


    <!-- Regimen Sanitario Neurologico Field -->
    <div class="form-group col-sm-12 flaggy" id="neuro_content" hidden="hidden">
        {!! Form::label('diagnos_concreto', 'Diagnóstico Concreto:') !!} {!! Form::select('diagnos_concreto', [
        'Parkinson' => 'Parkinson', 'Ictus' => 'Ictus', 'Traumatismo' => 'Traumatismo', 'Craneo-Encefálico' =>
        'Craneo-Encefálico', 'Deterioro cognitivo' =>
        'Deterioro cognitivo', 'Epilepsia' => 'Epilepsia', 'Otras' => 'Otras'], null, ['class' => 'form-control select2
        flagg', 'multiple' => 'multiple', 'required' => 'required']) !!}
    </div>

    <!-- Regimen Sanitario Demencia Field -->
    <div class="form-group col-sm-12 flaggy" id="demencia_content" hidden="hidden">
        {!! Form::label('diagnos_concreto', 'Diagnóstico Concreto:') !!} {!! Form::select('diagnos_concreto', [
        'Alzheimer' => 'Alzheimer', 'Mixta' => 'Mixta', 'Vascular' => 'Vascular', 'Frontal' => 'Frontal',
        'Fronto-temporal' => 'Fronto-temporal', 'Otras' =>
        'Otras'], null, ['class' => 'form-control select2 flagg', 'multiple' => 'multiple']) !!}
    </div>

    <!-- Regimen Sanitario Diversidad Fisica Field -->
    <div class="form-group col-sm-12 flaggy" id="diver_fisica_content" hidden="hidden">
        {!! Form::label('diagnos_concreto', 'Diagnóstico Concreto:') !!} {!! Form::select('diagnos_concreto', [
        'Discapacidad física' => 'Discapacidad física', 'Paraplejia' => 'Paraplejia', 'Hemiplejia' => 'Hemiplejia',
        'Tetraplejia' => 'Tetraplejia', 'Distrofia
        muscular' => 'Distrofia muscular', 'Amputación' => 'Amputación', 'Otras' => 'Otras'], null, ['class' =>
        'form-control select2 flagg', 'multiple' => 'multiple']) !!}
    </div>
    ...
    <div class="form-group col-sm-12 flaggy" id="diversidad_intel_content" hidden="hidden">
        {!! Form::label('diagnos_concreto', 'Diagnóstico Concreto:') !!} {!! Form::select('diagnos_concreto', [ 'Retraso
        mental' => 'Retraso mental', 'Discapacidad intelectual' => 'Discapacidad intelectual', 'Restraso del desarrollo'
        => 'Restraso del desarrollo',
        'Otras' => 'Otras'], null, ['class' => 'form-control select2 flagg', 'multiple' => 'multiple']) !!}
    </div>
    ...
    <div class="form-group col-sm-12 flaggy" id="diver_psiqAfect_content" hidden="hidden">
        {!! Form::label('diagnos_concreto', 'Diagnóstico Concreto:') !!} {!! Form::select('diagnos_concreto', [
        'Depresión' => 'Depresión', 'Trastorno psicótico' => 'Trastorno psicótico', 'Esquizofrenia' => 'Esquizofrenia',
        'Trastorno bipolar' => 'Trastorno bipolar',
        'Trastorno paranoide' => 'Trastorno paranoide', 'Otras' => 'Otras'], null, ['class' => 'form-control select2
        flagg', 'multiple' => 'multiple']) !!}
    </div>

    <!-- Regimen Sanitario Cardiopatías Field -->
    <div class="form-group col-sm-12 flaggy" id="cardio_content" hidden="hidden">
        {!! Form::label('diagnos_concreto', 'Diagnóstico Concreto:') !!} {!! Form::select('diagnos_concreto', [
        'Fibrilación auricular' => 'Fibrilación auricular', 'Insuficiencia venosa' => 'Insuficiencia venosa', 'Isquemia
        crónica' => 'Isquemia crónica', 'Insuficiencia
        cardiaca' => 'Insuficiencia cardiaca', 'Otras' => 'Otras'], null, ['class' => 'form-control select2 flagg',
        'multiple' => 'multiple']) !!}
    </div>

    <!-- Regimen Sanitario Prob. Respiratorios Field -->
    <div class="form-group col-sm-12 flaggy" id="prob_resp_content" hidden="hidden">
        {!! Form::label('diagnos_concreto', 'Diagnóstico Concreto:') !!} {!! Form::select('diagnos_concreto', [ 'EPOC'
        => 'EPOC', 'Insuficiencia respiratoria' => 'Insuficiencia respiratoria', 'Bronquitis crónica' => 'Bronquitis
        crónica', 'Otras' => 'Otras'],
        null, ['class' => 'form-control select2 flagg', 'multiple' => 'multiple']) !!}
    </div>
...
<!-- Submit Field -->
<div class="form-group col-sm-12">
    {!! Form::submit('Añadir diagnóstico', ['class' => 'btn btn-primary float-right', 'id' => 'addDiagnostic']) !!}
