...
<div class="form-group col-sm-6">
    ...
    {!! Form::select('dia_trans', ['' => '',  'Lunes' => 'Lunes', 'Martes' => 'Martes', 'Miércoles' => 'Miércoles', 'Jueves' => 'Jueves', 'Viernes' => 'Viernes'], null, ['class' => 'form-control', 'required' => 'required']) !!}
</div>

<!-- Tray Trans Field -->
<div class="form-group col-sm-6">
    {!! Form::label('tray_trans', 'Trayecto Transporte:') !!}
    {!! Form::select('tray_trans', ['' => '', 'Ida' => 'Ida', 'Vuelta' => 'Vuelta', 'Ida y Vuelta' => 'Ida y Vuelta'], null, ['class' => 'form-control', 'required' => 'required']) !!}
</div>
