<div class="row m-0 p-3">
    ...
    <div class="form-group col-sm-6">
        ...
        {!! Form::date('acc_fecha_reg', today(), ['class' => 'form-control','id'=>'reg_accion', 
    ...
    <div class="form-group col-sm-12 subtipo_acc" id="solic_demandas" style="display: none">
        {!! Form::label('', 'Subtipo Acción/Tarea:') !!}
        {!! Form::select('', [
    ...
    <div class="form-group col-sm-12 col-lg-12">
        ...
        {!! Form::textarea('acc_descrip', null, ['class' => 'form-control', 'required'=>'required']) !!}
    </div>
    ...
    <div class="form-group col-sm-12 col-lg-12">
        ...
        {!! Form::text('acc_observaciones', null, ['class' => 'form-control']) !!}
    </div>
