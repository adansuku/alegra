...
<div class="form-group col-sm-4">
    ...
    <select class="form-control" id="type" name="forma_pago">
        ...
        <option {{ $patient->patientOther->forma_pago == 'Domiciliación bancaria' ? 'selected':'' }}>Domiciliación bancaria</option>
    </select>
...
<div class="col-lg-4">
    ...
    <select class="form-control" id="type" name="pago_socio">
        ...
        <option {{ $patient->patientOther->pago_socio == 'Domiciliación bancaria' ? 'selected':'' }}>Domiciliación bancaria</option>
    </select>
