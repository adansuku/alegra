...
<div class="form-group col-sm-12">
    {!! Form::label('his_categoria', 'Categoria:') !!}
    {!! Form::select('his_categoria', [
        ''=>'',
...
<!-- His Tipo Field -->
<div class="form-group col-sm-12">
    {!! Form::label('his_tipo', 'Tipo:') !!}
    {!! Form::select('his_tipo', [''=>'', ' Contratos' => ' Contratos', ' Nóminas' => ' Nóminas', ' Vacaciones' => ' Vacaciones', ' Ausencias' => ' Ausencias', ' Permisos' => ' Permisos', ' Horas Extra' => ' Horas Extra', ' Informes Mensuales SPAPD' => ' Informes Mensuales SPAPD'], null, ['class' => 'form-control',  'required' => 'required']) !!}
</div>

<!-- His Respuesta Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('his_respuesta', 'Respuesta:') !!}
    {!! Form::text('his_respuesta', null, ['class' => 'form-control',  'required' => 'required']) !!}
</div>

<!-- His Observaciones Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('his_observaciones', 'Observaciones:') !!}
    {!! Form::textarea('his_observaciones', null, ['class' => 'form-control']) !!}
</div>
