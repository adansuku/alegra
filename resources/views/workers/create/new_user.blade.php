    ...
    <div class="col-sm-6">
        ...
        <div class="form-group ">
            ...
            <input id="nombre" type="text"
                class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }} form-control-user" name="nombre"
                value="{{ old('nombre') }}" placeholder="Introduce un nombre" required>
        ...
        <div class="form-group ">
            ...
            <input id="apellido" type="text"
                class="form-control{{ $errors->has('apellido') ? ' is-invalid' : '' }} form-control-user"
                name="apellido" value="{{ old('apellido') }}" placeholder="Introduce los apellidos" required>
    ...
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input id="email" type="email"
                ...
                value="{{ old('email') }}" placeholder="Introduce un email corporativo" required>
