...
<div class="container-fluid">
    <div class="card" id="editar_worker">
      <div class="card-header py-3">
            ...
            {!! Form::model($worker, ['route' => ['workers.update', $worker->id], 'method' => 'patch',  'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="laboral" role="tabpanel">
                        <div class="row">
                            <div class="col-sm-7">
                                <p class="my-3"><strong>Relación laboral del usuario:</strong>  {{$worker->nombre}} {{$worker->apellido}}</p>
                            </div>
                        ...
                        <div class="">
                                @include('workers.partials.relation_lab')
                    ...
                    <div class="tab-pane" id="documentation" role="tabpanel">
                        <div class="row">
                            <div class="col-sm-9">
                                <p class="my-3"><strong>Documentos del usuario:</strong> {{$worker->nombre}} {{$worker->apellido}}</p>
                            </div>
        ...
        {!! Form::submit('Guardar y salir', ['class' => 'btn btn-secondary float-right', 'value' => 'guardar_y_salir', 'name' => 'action']) !!}  
