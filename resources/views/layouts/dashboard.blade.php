...
<div class="container ">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 my-2">
            <a href="/workers/create" class="btn btn-sq-lg btn-secondary p-5 w-100">
        ...
        <div class="col-lg-3 my-2">
            <a href="/patients/create" class="btn btn-sq-lg btn-secondary p-5 w-100">
                <i class="fas fa-users fa-2x"></i> <i class="fas fa-plus-square"></i><br />
                <p class="pt-3">Añadir persona atendida</p>
            </a>
        </div>
        @endif @if(in_array(Auth::user()->role_id,[2,3]))
        <div class="col-lg-3 my-2 mx-auto">
            <a href="/worker_patients" class="btn btn-sq-lg btn-secondary p-5 w-100">
                <i class="fas fa-users fa-2x"></i><br />
                <p class="pt-3">Mis personas antendidas</p>
            </a>
        </div>
        @endif
