<div class="row m-0 p-3">
    ...
    <div class="form-group col-sm-12">
        ...
        <select class="form-control select2" id="municipio" name="municipio_carer">
            ...
            <option {{ $patientCarer->municipio_carer == 'Buenavista del Norte' ? 'selected':'' }}>Buenavista del Norte</option>
            ...
            <option {{ $patientCarer->municipio_carer == 'Granadilla de Abona' ? 'selected':'' }}>Granadilla de Abona</option>
            ...
            <option {{ $patientCarer->municipio_carer == 'Icod de los Vinos' ? 'selected':'' }}>Icod de los Vinos</option>
            <option {{ $patientCarer->municipio_carer == 'La Guancha' ? 'selected':'' }}>La Guancha</option>
            <option {{ $patientCarer->municipio_carer == 'La Matanza de Acentejo' ? 'selected':'' }}>La Matanza de Acentejo</option>
            <option {{ $patientCarer->municipio_carer == 'La Orotava' ? 'selected':'' }}>La Orotava</option>
            <option {{ $patientCarer->municipio_carer == 'La Victoria de Acentejo' ? 'selected':'' }}>La Victoria de Acentejo</option>
            ...
            <option {{ $patientCarer->municipio_carer == 'Puerto de la Cruz' ? 'selected':'' }}>Puerto de la Cruz</option>
            <option {{ $patientCarer->municipio_carer == 'San Cristóbal de la Laguna' ? 'selected':'' }}>San Cristóbal de la Laguna</option>
            <option {{ $patientCarer->municipio_carer == 'San Juan de la Rambla' ? 'selected':'' }}>San Juan de la Rambla</option>
            <option {{ $patientCarer->municipio_carer == 'San Miguel de Abona' ? 'selected':'' }}>San Miguel de Abona</option>
            <option {{ $patientCarer->municipio_carer == 'Santa Cruz de Tenerife' ? 'selected':'' }}>Santa Cruz de Tenerife</option>
            <option {{ $patientCarer->municipio_carer == 'Santa Úrsula' ? 'selected':'' }}>Santa Úrsula</option>
            <option {{ $patientCarer->municipio_carer == 'Santiago del Teide' ? 'selected':'' }}>Santiago del Teide</option>
            ...
            <option {{ $patientCarer->municipio_carer == 'San Sebastián de la Gomera' ? 'selected':'' }}>San Sebastián de la Gomera</option>
            ...
            <option {{ $patientCarer->municipio_carer == 'El Pinar de El Hierro' ? 'selected':'' }}>El Pinar de El Hierro</option>
            ...
            <option {{ $patientCarer->municipio_carer == 'Fuencaliente de la Palma' ? 'selected':'' }}>Fuencaliente de la Palma</option>
            <option {{ $patientCarer->municipio_carer == 'Garafía' ? 'selected':'' }}>Garafía</option>
            <option {{ $patientCarer->municipio_carer == 'Los Llanos de Aridane' ? 'selected':'' }}>Los Llanos de Aridane</option>
            ...
            <option {{ $patientCarer->municipio_carer == 'San Andrés y Sauces' ? 'selected':'' }}>San Andrés y Sauces</option>
            <option {{ $patientCarer->municipio_carer == 'Santa Cruz de la Palma' ? 'selected':'' }}>Santa Cruz de la Palma</option>
            <option {{ $patientCarer->municipio_carer == 'Tazacorte' ? 'selected':'' }}>Tazacorte</option>
            <option {{ $patientCarer->municipio_carer == 'Tijarafe y Villa de Mazo' ? 'selected':'' }}>Tijarafe y Villa de Mazo</option>
            ...
            <option {{ $patientCarer->municipio_carer == 'Puerto del Rosario' ? 'selected':'' }}>Puerto del Rosario</option>
            ...
            <option {{ $patientCarer->municipio_carer == 'La Aldea de San Nicolás' ? 'selected':'' }}>La Aldea de San Nicolás</option>
            ...
            <option {{ $patientCarer->municipio_carer == 'Las Palmas de Gran Canaria' ? 'selected':'' }}>Las Palmas de Gran Canaria</option>
            <option {{ $patientCarer->municipio_carer == 'San Bartolomé de Tirajana' ? 'selected':'' }}>San Bartolomé de Tirajana</option>
            <option {{ $patientCarer->municipio_carer == 'Santa Brígida' ? 'selected':'' }}>Santa Brígida</option>
            <option {{ $patientCarer->municipio_carer == 'Santa Lucía de Tirajana' ? 'selected':'' }}>Santa Lucía de Tirajana</option>
            <option {{ $patientCarer->municipio_carer == 'Santa María de Guía de Gran Canaria' ? 'selected':'' }}>Santa María de Guía de Gran Canaria</option>
            ...
            <option {{ $patientCarer->municipio_carer == 'Valsequillo de Gran Canaria' ? 'selected':'' }}>Valsequillo de Gran Canaria</option>
            <option {{ $patientCarer->municipio_carer == 'Vega de San Mateo.' ? 'selected':'' }}>Vega de San Mateo.</option>
        </select>
    </div>
    ...
    <!-- Submit Field -->
    <div class="form-group col-sm-12">
        {!! Form::submit('Actualizar cuidadora', ['class' => 'btn btn-primary float-right' ]) !!}
