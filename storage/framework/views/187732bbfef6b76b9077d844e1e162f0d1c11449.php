            ...
            <div class="col-md-6">
                <div class="float-sm-right">
                    <a class="btn btn-primary add-worker"
                        href="<?php echo route('patients.create'); ?>">Añadir persona</a>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/patients/index.blade.php ENDPATH**/ ?>