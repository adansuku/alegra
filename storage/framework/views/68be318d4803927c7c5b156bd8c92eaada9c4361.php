<div class="row">
    ...
    <div class="form-group col-sm-6">
        ...
        <?php echo Form::date('fecha_form_serv', null, ['class' => 'form-control','id'=>'fecha_form_serv','required' =>
        'required']); ?>
...
</div><?php /**PATH /var/www/resources/views/patients/create/services.blade.php ENDPATH**/ ?>