...
<div class="form-group col-sm-6">
    <?php echo Form::label('fecha_inicio_serv', 'Fecha de formalización:'); ?>

    <?php echo Form::date('fecha_inicio_serv', null, ['class' => 'form-control','id'=>'fecha_inicio_serv', 'required' => 'required']); ?>
...
<!-- Lugar Serv Field -->
<div class="form-group col-sm-6">
    <?php echo Form::label('lugar_serv', 'Municipio :'); ?>
...
<!-- Dias Serv Field -->
<div class="form-group col-sm-6">
    <?php echo Form::label('dias_serv', 'Dias del servicio:'); ?>

    <?php echo Form::select('dias_serv[]', ['Lunes' => 'Lunes', 'Martes' => 'Martes', 'Miércoles' => 'Miércoles',
...
<!-- Horario Serv Field -->
<div class="form-group col-sm-6">
    <?php echo Form::label('horario_serv', 'Horario:'); ?>
...
<div class="form-group col-sm-12">
    <?php echo Form::submit('Crear servicio', ['class' => 'btn btn-primary']); ?>

    <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
</div>

</div><?php /**PATH /var/www/resources/views/patients/create/service.blade.php ENDPATH**/ ?>