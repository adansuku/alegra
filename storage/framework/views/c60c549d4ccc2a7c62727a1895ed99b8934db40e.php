<div class="row p-3">
    ...
    <div class="form-group col-sm-12 flaggy" id="neuro_content" hidden="hidden">
        <?php echo Form::label('diagnos_concreto', 'Diagnóstico Concreto:'); ?>

        <?php echo Form::select('diagnos_concreto', [
        'Parkinson' => 'Parkinson',
        'Ictus' => 'Ictus',
    ...
    <div class="form-group col-sm-12" id="diagnos_concreto_cont" hidden="hidden">
        <?php echo Form::label('diagnos_concreto_otro', 'Si no esta en la lista, especifica cual:'); ?>

        <?php echo Form::text('diagnos_concreto_otro', null, ['class' => 'form-control', 'name' => 'diagnos_concreto[]']); ?>
...
<!-- Submit Field -->
<div class="form-group col-sm-12">
    <?php echo Form::submit('Añadir diagnóstico', ['class' => 'btn btn-primary float-right']); ?>

    <a href="<?php echo route('patientDiagnostics.index'); ?>" class="btn btn-default float-right"
