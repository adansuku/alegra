...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">People</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <h1 class="float-sm-right">
                <a class="btn btn-primary" style="margin-top: -10px;margin-bottom: 5px" href="<?php echo route('people.create'); ?>">Add New</a>
            </h1>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/people/index.blade.php ENDPATH**/ ?>