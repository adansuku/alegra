...
<?php echo e(Auth::user()->id); ?>
            ...
            <?php echo Form::open(['url' => route('workerTimes.store', ['worker_id' => Auth::user()->id]),'method' => 'POST']); ?>

                <?php echo $__env->make('worker_times.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/worker_times/index.blade.php ENDPATH**/ ?>