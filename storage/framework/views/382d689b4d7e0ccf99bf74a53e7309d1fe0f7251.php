<div class="row m-0 p-3">
    ...
    <div class="form-group col-sm-6">
        ...
        <?php echo Form::date('acc_fecha_reg', null, ['class' => 'form-control','id'=>'reg_accion', 'required' => 'required']); ?>
    ...
    <div class="form-group col-sm-6">
        <?php echo Form::label('acc_fecha_realiz', 'Fecha realización:'); ?>
    ...
    <div class="form-group col-sm-12 flagy" id="solic_demandas_cont" hidden="hidden">
        <?php echo Form::label('acc_subtipo_accion', 'Subtipo Acción/Tarea:'); ?>

        <?php echo Form::select('acc_subtipo_accion', [
        '' => 'Selecciona una:',
        'Alta' => 'Alta',
        'Cambio' => 'Cambio',
    ...
    <div class="form-group col-sm-12" id="acc_subtipo_accion_otro_cont" hidden="hidden">
        <?php echo Form::label('acc_subtipo_accion_otro', 'Si no esta en la lista, especifica cual:'); ?>

        <?php echo Form::text('acc_subtipo_accion_otro', null, ['class' => 'form-control', 'name' => 'acc_subtipo_accion']); ?>

    </div>

    <!-- Woker Accion Field -->
    <div class="form-group col-sm-12">
        <?php echo Form::label('acc_woker_accion', 'Acción del trabajador:'); ?>

        <?php echo Form::text('acc_woker_accion', null, ['class' => 'form-control', 'required' => 'required']); ?>
    ...
    <div class="form-group col-sm-12 col-lg-12">
        ...
        <?php echo Form::textarea('acc_descrip', null, ['class' => 'form-control']); ?>
    ...
    <div class="form-group col-sm-12 col-lg-12">
        ...
        <?php echo Form::textarea('acc_observaciones', null, ['class' => 'form-control']); ?>
