...
<li class="<?php echo e(Request::is('workers*') ? 'active' : ''); ?> nav-item">
    ...
    <div id="workers-tab" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        ...
        <a class="collapse-item" href="<?php echo route('workers.create'); ?>"><i class="fas fa-plus"></i> Añadir trabajador/a</a>
        <a class="collapse-item" href="<?php echo route('workers.index'); ?>"><i class="fas fa-list"></i>  Lista trabajadores/as</a>
        </div>
    </div>
</li>
...
<a class="nav-link" href="" data-toggle="collapse" data-target="#patients-tab" aria-expanded="true" aria-controls="collapseTwo">
    ...
    <div id="patients-tab" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Opciones:</h6>
        <a class="collapse-item" href="<?php echo route('patients.create'); ?>"><i class="fas fa-plus"></i> Añadir persona</a>
        <a class="collapse-item" href="<?php echo route('patients.index'); ?>"><i class="fas fa-list"></i>  Lista personas</a>
        </div>
    </div>
</li>
