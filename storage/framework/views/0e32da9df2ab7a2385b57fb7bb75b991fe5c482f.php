...
<div class="form-group col-sm-12">
    ...
    <?php echo Form::text('nombre_documento', null, ['class' => 'form-control', 'required' => 'required']); ?>
...
<?php /**PATH /var/www/resources/views/workers/create/documents.blade.php ENDPATH**/ ?>