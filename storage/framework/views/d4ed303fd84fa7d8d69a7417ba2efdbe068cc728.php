...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Patient Carer</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <?php echo Form::open(['route' => 'patientCarers.store']); ?>
...
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/patient_carers/create.blade.php ENDPATH**/ ?>